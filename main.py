...
if __name__=="__main__":
    ...
    labels = ['I_drug', 'I_crowd', 'I_body', 'B_disease', 'I_test', 'I_symptom', 'B_symptom', 'B_drug', 'B_treatment', 
'I_feature', 'B_body', 'I_treatment', 'B_physiology', 'B_crowd', 'I_time', 'B_time', 'B_test', 'B_feature', 'I_physiology', 'I_disease', 'I_department', 'B_department']
    ...
    parser.add_argument("--trainset", type=str, default="cMedQANER\\train.txt")
    parser.add_argument("--validset", type=str, default="cMedQANER\\dev.txt")
    parser.add_argument("--testset", type=str, default="cMedQANER\\test.txt")
